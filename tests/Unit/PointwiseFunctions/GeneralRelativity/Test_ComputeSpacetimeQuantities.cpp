...
SPECTRE_TEST_CASE("Unit.PointwiseFunctions.GeneralRelativity.SpacetimeDecomp",
  ...
  test_compute_spacetime_metric<1>(dv);
  test_compute_spacetime_metric<2>(dv);
  test_compute_spacetime_metric<3>(dv);
  test_compute_spacetime_metric<1>(d);
  test_compute_spacetime_metric<2>(d);
  test_compute_spacetime_metric<3>(d);

  test_compute_inverse_spacetime_metric<1>(dv);
  test_compute_inverse_spacetime_metric<2>(dv);
  test_compute_inverse_spacetime_metric<3>(dv);
  test_compute_inverse_spacetime_metric<1>(d);
  test_compute_inverse_spacetime_metric<2>(d);
  test_compute_inverse_spacetime_metric<3>(d);

  test_compute_derivatives_of_spacetime_metric<1>(dv);
  test_compute_derivatives_of_spacetime_metric<2>(dv);
  test_compute_derivatives_of_spacetime_metric<3>(dv);
  test_compute_derivatives_of_spacetime_metric<1>(d);
  test_compute_derivatives_of_spacetime_metric<2>(d);
  test_compute_derivatives_of_spacetime_metric<3>(d);

  test_compute_spacetime_normal_vector<1>(dv);
  test_compute_spacetime_normal_vector<2>(dv);
  test_compute_spacetime_normal_vector<3>(dv);
  test_compute_spacetime_normal_vector<1>(d);
  test_compute_spacetime_normal_vector<2>(d);
  test_compute_spacetime_normal_vector<3>(d);
  ...
  test_compute_spacetime_normal_one_form<1>(d);
  test_compute_spacetime_normal_one_form<2>(d);
  test_compute_spacetime_normal_one_form<3>(d);

  test_compute_spatial_metric_lapse_shift<1>(d);
  test_compute_spatial_metric_lapse_shift<2>(d);
  test_compute_spatial_metric_lapse_shift<3>(d);
  ...
  test_compute_extrinsic_curvature<1>(dv);
  test_compute_extrinsic_curvature<2>(dv);
  test_compute_extrinsic_curvature<3>(dv);
  test_compute_extrinsic_curvature<1>(d);
  test_compute_extrinsic_curvature<2>(d);
  test_compute_extrinsic_curvature<3>(d);
}

...
SPECTRE_TEST_CASE("Unit.PointwiseFunctions.GeneralRelativity.GhQuantities",
  ...
  test_compute_phi<1>(dv);
  test_compute_phi<2>(dv);
  test_compute_phi<3>(dv);
  test_compute_phi<1>(d);
  test_compute_phi<2>(d);
  test_compute_phi<3>(d);
  test_compute_pi<1>(dv);
  test_compute_pi<2>(dv);
  test_compute_pi<3>(dv);
  test_compute_pi<1>(d);
  test_compute_pi<2>(d);
  test_compute_pi<3>(d);
  test_compute_gauge_source<1>(dv);
  test_compute_gauge_source<2>(dv);
  test_compute_gauge_source<3>(dv);
  test_compute_gauge_source<1>(d);
  test_compute_gauge_source<2>(d);
  test_compute_gauge_source<3>(d);
  test_compute_extrinsic_curvature_and_deriv_metric<1>(d);
  test_compute_extrinsic_curvature_and_deriv_metric<2>(d);
  test_compute_extrinsic_curvature_and_deriv_metric<3>(d);
